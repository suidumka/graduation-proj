...
public class DB_Utility {
    ...
    public static void createConnection(){
       ...
       // String url = "jdbc:oracle:thin:@18.234.251.252:1521:XE" ;
        String url = ConfigurationReader.getProperty("hrDBUrl"); // Since we have added config.properties and ConfigReader, I can get directly from there as well
        //String username =  "hr";
        // String password =  "hr";
        String username = ConfigurationReader.getProperty("hrDBUsername");
        String password = ConfigurationReader.getProperty("hrDBPassword");
