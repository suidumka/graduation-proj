...
public class DB_Utility {
    ...
    public static void createConnection(){
       ...
       // String url = "jdbc:oracle:thin:@18.234.251.252:1521:XE" ;
        String url = ConfigurationReader.getProperties("hrDBUrl"); // Since we have added config.properties and ConfigReader, I can get directly from there as well
        //String username =  "hr";
        // String password =  "hr";
        String username = ConfigurationReader.getProperties("hrDBUsername");
        String password = ConfigurationReader.getProperties("hrDBPassword");
    ...
    public static void docuportCreateConnection(){
        ...
        String docuportUrl = ConfigurationReader.getProperties("docuportDBURL");
        ...
        createConnection(docuportUrl, username, password);
    }
