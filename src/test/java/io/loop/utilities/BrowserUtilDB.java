...
public class BrowserUtilDB {
    ...
    public static void waitForPresenceOfElement(By by, long time) {
        new WebDriverWait(Driver.getDriver(), Duration.ofSeconds(DocuportConstants.LARGE)).until(ExpectedConditions.presenceOfElementLocated(by));
    }
