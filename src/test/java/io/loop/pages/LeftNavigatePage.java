...
public class LeftNavigatePage extends Base {
    ...
    public void clickButton(String button) {
        switch (button.toLowerCase().trim()) {
            ...
            case "upload" ->
                   // BrowsersUtils.waitForClickable(uploadButton, DocuportConstants.LARGE).click();
            BrowsersUtils.clickWithJS(uploadButton);
         /*   case "home" -> {
                try {
            ...
            case "received doc" ->
                   // BrowsersUtils.waitForClickable(receivedDocsButton, DocuportConstants.LARGE).click();
            BrowsersUtils.clickWithJS(receivedDocsButton);
            case "my uploads" ->
                //BrowsersUtils.waitForClickable(myUploads, DocuportConstants.EXTRA_LARGE).click();
                    BrowsersUtils.clickWithJS(myUploads);
            case "invitations" -> {
                try {
            ...
            case "terms and conditions" ->
                    BrowsersUtils.waitForClickable(termsAndConditionsButton, DocuportConstants.LARGE).click();
